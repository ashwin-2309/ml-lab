...
mse_train_autoencoder = autoencoder.evaluate(X_train, X_train)
mse_test_autoencoder = autoencoder.evaluate(X_test, X_test)

print("Comparison of PCA and Autoencoder performance:")
print(f"MSE on train set with PCA: {mse_train_pca:.2f}")
print(f"MSE on test set with PCA: {mse_test_pca:.2f}")
