...
\begin{tabular*}{\textwidth}{l@{\extracolsep{\fill}}r}
  \textbf{{\LARGE Ashwin Kumar Singh}} & Email: \href{mailto:}{ashwinsingh2309.aks@gmail.com}\\
    Mobile:~~~+91-9667855368 \\
  \href{https://github.com/ash23090}{Github} \\
    \href{https://leetcode.com/pheonix_ash}{Leetcode}
\end{tabular*}
...
\section{~~Education}
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      {Bachelor of Technology - Computer Science;  GPA: 7.27}{July 2020 - June 2024}
...
\section{Skills Summary}
	...
	\resumeSubItem{FrontEnd}{~~~~~~HTML,CSS,Javascript,ReactJS,NextJS}
    \resumeSubItem{Libraries}{~~~~~~~Material UI,Chakra UI,Tailwind CSS}
	\resumeSubItem{Backend}{~~~~~~~~Node JS,Express JS,Django}
